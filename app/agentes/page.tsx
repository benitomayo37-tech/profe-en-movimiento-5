...
export const metadata: Metadata = { title: "Agentes IA | Profe en Movimiento", description: "Coordinación inteligente para planificación, evaluación e inclusión." };
